...
## Description
This project is a customer-side e-commerce application that includes basic features typically found on e-commerce websites. It aims to implement React, React Router DOM, and Redux in a real-world project. The data for this project is sourced from [Fake Store API](https://fakestoreapi.com/) (fakestoreapi.com).
...
1. Clone the repository
   ```bash
   git clone https://github.com/rejabagja/shop-ease.git
   ```
